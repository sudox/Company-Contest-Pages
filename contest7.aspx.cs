...
public class Contest
{
    ...
    {
        using (System.IO.StreamWriter file = new System.IO.StreamWriter("C:/inetpub/wwwroot/Contest/emails7.txt"))
        {
    ...
    {
        using (System.IO.StreamWriter file = new System.IO.StreamWriter("C:/inetpub/wwwroot/Contest/answers7.txt"))
        {
    ...
    {
        string line;
        using (System.IO.StreamReader file = new System.IO.StreamReader("C:/inetpub/wwwroot/Contest/emails7.txt"))
        {
    ...
    {
        string line;
        using (System.IO.StreamReader file = new System.IO.StreamReader("C:/inetpub/wwwroot/Contest/answers7.txt"))
        {
            while ((line = file.ReadLine()) != null)
            {
...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Submit_Click(object sender, EventArgs e)
    {
            ...
            results.answers.Add(String.Format("Country: {0}, State: {1}, City: {2}, Color: {3}, Email: {4}", hiddenCountry.Value, hiddenState.Value, town.Text, color.Text, email.Text));
