...
public class Contest
{
    ...
    {
        using (System.IO.StreamWriter file = new System.IO.StreamWriter("C:/inetpub/wwwroot/Contest/answers.txt"))
        {
    ...
    {
        string line;
        using (System.IO.StreamReader file = new System.IO.StreamReader("C:/inetpub/wwwroot/Contest/answers.txt"))
        {
            while((line = file.ReadLine()) != null)
            {
...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Submit_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            ...
            content.InnerHtml += "<h1>Check back at the end of February.</h1>\n";
        }
    }
}
